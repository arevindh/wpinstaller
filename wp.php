...
<html>
<title> WordPress Installer By Siddhu Arevindh  <?php if (isset($_GET['step'])) { echo " |  Step: ".$page; }  ?> </title>
...
{     
	 ...
	 echo "<b><br /><a href='wp.php?step=1'> Proceed with Install </a></b>";
...
if ($page==1)
{
	...
	echo "<b> <br /> <a href='wp.php?step=2'> Next Step (2) </a> </b>";
	  echo " <br /> <br /> <br /> Script By  <a href='http://www.arevindh.com/'> Siddhu Arevindh  </a>";
	...
	if ($res === TRUE) 
		{
			...
			echo "<b><br /><a href='wp.php?step=3'> Next Step (3) </a></b>";		
			echo " <br /> <br /> <br /> Script By  <a href='http://www.arevindh.com/'> Siddhu Arevindh  </a>";			
		} 
